...
export default function Promotions() {
  return (
    <><div className="max-md:mt-30">
      ...
      <div className="flex  my-6 justify-center   max-[1200px]:flex-col">
         <div className="left w-[800px] max-md:w-full 2xl:bg-gray-200 max-md:flex-col max-[1200px]:w-full  ">
       ...
       <div className="right  w-[650px] h-96 max-md:h-auto flex justify-center max-md:flex-col max-[1200px]:w-full md:max-[1200px]:justify-around max-md:mt-12 max-md:w-full ">
        <div className="mx-2 max-md:mx-0 bg-[#efe1c7] max-md:flex  max-md:flex-col max-md:justify-center">
            <h2 className="m-4">
              Flex Sweatshirt <br />
          ...
          <div className="mx-2 max-md:mx-0 bg-[#d7d7d9] max-md:mt-6 max-md:flex max-md:flex-col max-md:justify-center">
